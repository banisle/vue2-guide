...
import CompoMainToast from "@/components/CompoMainToast";
...
import CompoAcdGroupTree from '@/components/CompoAcdGroupTree'
...
import { mixinAs } from "@/mixin/mixinAs.js";
...
import crosseditor from "@/components/CompoCrossEditor.vue";
...
const uiComponents = [
  ...
  { name: 'CompoMainToast', component: CompoMainToast },
  ...
  { name: 'CompoAcdGroupTree', component: CompoAcdGroupTree },
  ...
  { name: 'Teleport', component: Teleport },
  { name: 'crosseditor', component: crosseditor },
];
...
Vue.mixin({
  beforeCreate() {
    if (process.env.VUE_APP_ENV === 'local' && this.$options.__file) {
      if(this.$options.__file.indexOf('/CompoTooltipBtn.vue') === -1
        && this.$options.__file.indexOf('/CompoTabItems.vue') === -1
        && this.$options.__file.indexOf('/CompoDateRangePicker.vue') === -1
        && this.$options.__file.indexOf('/CompoDatePicker.vue') === -1
        && this.$options.__file.indexOf('/CompoDropPicker.vue') === -1
      ){
        console.log(`[DEBUG] Mounted Component: ${this.$options.__file}`);
      }
    }
  }
});
