...
export const stompUtil = new Vue({
    ...
    methods: {
        ...
        connect(connectCallback, errorCallback) {
            console.log("웹소켓 연결 시도", this.connected);
            ...
            if (!this.connected) {
                ...
                this.stompClient.connect(
                    ...
                    frame => { 
                        console.log("웹소켓 connect 성공", frame);
            ...
            return new Promise((resolve , reject) => { 
                ...
                var sendData = {
                    ...
                    , DATA: [{
                        ...
                        , file : MSG_INFO.file != '' ? MSG_INFO.file : ''
                        ...
                        , LNK_INFO : MSG_INFO.FILE_NM != '' ? MSG_INFO.FILE_NM : ''
                    }]
                };
                ...
                this.stompClient.send("/app/inout/chat/message", sendDataStr, { "token": CHAT_INFO.token, "userKey": CHAT_INFO.chtUserKey});
