const alertStore = {
  ...
  mutations: {
    ...
    showAlert(state,{ alertDialogToggle, iconClass, msg, type, isloading, callYes, callNo, downloadable, downReason, downReasonChk, phnNoConfirm, custPhnNo, custPhnNoChk, callAfter }){
