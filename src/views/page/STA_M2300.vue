...
import STA_M2300_TAB01 from '@/views/page/STA_M2300_TAB01.vue';
import STA_M2300_TAB02 from '@/views/page/STA_M2300_TAB02.vue';

export default {
  name: 'MENU_STA_M2300', //해피콜 현황
  components: {
    CompoTabItems,
    STA_M2300_TAB01,
    STA_M2300_TAB02,
  ...
  data() {
    return {
      ...
      // tabsList1
      TabsList: [
        { title: '(신)해피콜불만현황', content: 'STA_M2300_TAB01', badge: false },
        { title: '(구)해피콜불만현황', content: 'STA_M2300_TAB02', badge: false },
      ],
      ARA_HDQ_CD_LIST : [],
      HPC_SURVEY_LIST : [],
      HPC_CODE_LIST : [],
