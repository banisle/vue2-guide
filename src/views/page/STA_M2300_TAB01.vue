...
<!--              style="width: 271px;"-->
      ...
      <div class="pl-grid-top pt-2">
        <div class="pl-grid-top-left spacing-wrap sp-16 ">
          <div class="spacing-wrap sp-8">
            <div>
              <strong class="pl-bullet-txt is-blue">(신)해피콜불만현황</strong>
            </div>
          </div>
        </div>
    ...
    <v-dialog
        ...
        width="1410"
        content-class="dialog-draggable is-mid"
        hide-overlay>
...
export default {
  ...
  data() {
    return {
      ...
      headersRowSpan: [
        ...
        { text: '부위자재', value: 'REON_MTRL_NM', align: 'center pl-text-pre-wrap px-1', width: '50px', sortable: false },
        { text: 'AS유형', value: 'MNTN_FLW_TP_NM', align: 'center pl-text-pre-wrap px-1', width: '', sortable: false },
        { text: '공종', value: 'MNTN_CSTP_NM', align: 'center pl-text-pre-wrap px-1', width: '', sortable: false },
        { text: '공사', value: 'MNTN_CON_NM', align: 'center pl-text-pre-wrap px-1', width: '4%', sortable: false },
        ...
        { text: '해피콜처리내용', value: 'CUTT_CN', align: ' pl-text-pre-wrap px-1', width: '100px', sortable: false },
        { text: '불만코드', value: 'HAPPY_CMPL_NM', align: 'center pl-text-pre-wrap px-1', width: '60px', sortable: false },
        { text: '보수\n지시일', value: 'RPR_NSTC_DT', align: 'center pl-text-pre-wrap px-1', width: '80px', sortable: false },
        { text: '완료\n보고일', value: 'RPR_CMPL_RPT_DT', align: 'center pl-text-pre-wrap px-1', width: '80px', sortable: false },
        { text: '완료일', value: 'RPR_CMPL_DT', align: 'center pl-text-pre-wrap px-1', width: '80px', sortable: false },
        { text: '사업자번호', value: 'R_FRM_CD', align: ' pl-text-pre-wrap px-1', width: '80px', sortable: false },
      ...
      headersExcel: [
        { text: '번호', value: 'ROW_NUMBER', align: 'left', width: '80px', sortable: false },
        { text: '민원인', value: 'CVPR_NM', align: 'left', width: '80px', sortable: false },
        { text: '휴대전화번호', value: 'MBL_NO', align: 'left', width: '80px', sortable: false },
        { text: '주소(계약정보)', value: 'ADDRESS', align: 'left', width: '80px', sortable: false },
        { text: 'AS접수번호', value: 'V_FLW_ACP_SN', align: 'left', width: '80px', sortable: false },
        { text: 'AS구분', value: 'FLW_DS_NM', align: 'left', width: '80px', sortable: false },
        { text: '보수구분', value: 'FLW_DTL_DS_NM', align: 'left', width: '80px', sortable: false },
        { text: '단지/동 주소', value: 'MGOF_NM_ADR', align: 'left', width: '80px', sortable: false },
        { text: '임대유형', value: 'MGOF_TP_NM', align: 'left', width: '80px', sortable: false },
        { text: '지역구분', value: 'ARA_HDQ_NM', align: 'left', width: '80px', sortable: false },
        { text: '시설구분', value: 'LCLS_NM', align: 'left', width: '80px', sortable: false },
        { text: '동', value: 'BLDG_NO', align: 'left', width: '80px', sortable: false },
        { text: '호', value: 'HS_NO', align: 'left', width: '80px', sortable: false },
        { text: '부위자재', value: 'REON_MTRL_NM', align: 'left', width: '80px', sortable: false },
        { text: 'AS유형', value: 'MNTN_FLW_TP_NM', align: 'left', width: '80px', sortable: false },
        { text: '공종', value: 'MNTN_CSTP_NM', align: 'left', width: '80px', sortable: false },
        { text: '공사', value: 'MNTN_CON_NM', align: 'left', width: '80px', sortable: false },
        { text: '업체명', value: 'FRM_NM', align: 'left', width: '80px', sortable: false },
        { text: '담당자', value: 'ICPR', align: 'left', width: '80px', sortable: false },
        { text: '처리자', value: 'PRCR_NM', align: 'left', width: '80px', sortable: false },
        { text: '사용자구분', value: 'MNTN_USR_DS_NM', align: 'left', width: '80px', sortable: false },
        { text: '경과시간', value: 'RPR_XPC_OV_DAY', align: 'left', width: '80px', sortable: false },
        { text: 'AS내용', value: 'FLW_CTS', align: 'left', width: '80px', sortable: false },
        { text: '접수일', value: 'FLW_RGS_DT', align: 'left', width: '80px', sortable: false },
        { text: '처리상태', value: 'FLW_PGRS_SS_NM', align: 'left', width: '80px', sortable: false },
        { text: '접수채널', value: 'ACP_CHNL_NM', align: 'left', width: '80px', sortable: false },
        { text: '진행상담원', value: 'PRCS_USER_NM', align: 'left', width: '80px', sortable: false },
        { text: '등록일자', value: 'REG_DT', align: 'left', width: '80px', sortable: false },
        { text: '진행고객', value: 'CALLER_NM', align: 'left', width: '80px', sortable: false },
        { text: '해피콜접수(평균)', value: 'EXMP_AVG', align: 'left', width: '80px', sortable: false },
        { text: '1.방문시간', value: 'EXMP_VAL1', align: 'left', width: '80px', sortable: false },
        { text: '2.친절', value: 'EXMP_VAL2', align: 'left', width: '80px', sortable: false },
        { text: '3.보수만족', value: 'EXMP_VAL3', align: 'left', width: '80px', sortable: false },
        { text: '4.뒷마무리', value: 'EXMP_VAL4', align: 'left', width: '80px', sortable: false },
        { text: '5.복장', value: 'EXMP_VAL5', align: 'left', width: '80px', sortable: false },
        { text: '해피콜처리내용', value: 'CUTT_CN', align: 'left', width: '80px', sortable: false },
        { text: '불만내용', value: 'HAPPY_CMPL_CNTNT', align: 'left', width: '80px', sortable: false },
        { text: '불만코드', value: 'HAPPY_CMPL_NM', align: 'left', width: '80px', sortable: false },
        { text: '통화상태', value: 'CUTT_TYPE_NM', align: 'left', width: '80px', sortable: false },
        { text: '미진행결과사유', value: 'NOT_PROC_CNTNT', align: 'left', width: '80px', sortable: false },
        { text: '보수지시일', value: 'RPR_NSTC_DT', align: 'left', width: '80px', sortable: false },
        { text: '완료보고일', value: 'RPR_CMPL_RPT_DT', align: 'left', width: '80px', sortable: false },
        { text: '완료일', value: 'RPR_CMPL_DT', align: 'left', width: '80px', sortable: false },
        { text: '사업자번호', value: 'R_FRM_CD', align: 'left', width: '80px', sortable: false },
        { text: '권역명', value: 'DISTRICT_NM', align: 'left', width: '80px', sortable: false },
        { text: '상세단지동주소', value: 'BLDG_ADR', align: 'left', width: '80px', sortable: false },
        { text: '공간', value: 'SPCE_NM', align: 'left', width: '80px', sortable: false },
      ],
      itemsRowSpan: [],
      srchParam : {
  ...
  methods: {
    ...
    async getStatsHpcSurveyNew(){
      this.itemsRowSpan=[];
      this.isLoading = true;
      let sUrl = '/api/biz/common/select/selectStatsHpcSurveyNew'
      let postParam = {
