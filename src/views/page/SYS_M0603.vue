        ...
        <v-tabs-items v-model="tab" class="pl-tabs-items">
          ...
          <v-tab-item>
            <div class="pl-cols fill-height">
              <div class="is-col-fix is-vrt fill-height" style="width: 22%;">
                ...
                <div class="is-col-fix is-vrt" >
                  <div class="">
                    ...
                    <div class="pl-card-body pl-tree-body" style="height: calc(-262px + 100vh);">
                      <v-treeview
                        ref="treeDefault"
                  ...
                  <div class="pl-cols">
                    <div>
                      <div class="pl-grid-top px-0">
                        <h2 class="pl-subtit">[{{ QSTN_TYPE_NM }}]에 설정되지 않은 사용자</h2>
          ...
          <v-tab-item>
            <div class="is-vrt">
              <!-- 사용자 -->
              <div class="pl-search-header is-border-bottom">
                <div class="pl-form-inline-wrap">
                  <div class="pl-form-inline">
                    <span class="pl-label">
                      사용자 ID
              ...
              <!-- grid -->
              <div class="pl-card-body pt-2">
                <div class="pl-cols">
                  <div>
                    <div class="pl-grid-top px-0">
                      <strong class="pl-bullet-txt is-blue">미할당 스킬( {{ SRCH_USER.LGN_ID }} / {{ SRCH_USER.USER_NM }}) </strong>
                  ...
                  <div>
                    <div class="pl-grid-top px-0">
                      <strong class="pl-bullet-txt is-blue">설정한 문의 유형</strong>
...
<script>
export default {
name:"MENU_SYS_M0603", //name은 'MENU_' + 파일명 조합
components: {
},
data() {
   return {
    ...
    ROW_PER_PAGE2: -1,
    UN_STNG_USER_HEADER: [
      { text: '번호', value: 'ROW_NUMBER', width: '50px' },
      { text: '사용자ID', value: 'LGN_ID', width: '15%' },
      { text: '사용자명', value: 'USER_NM', width: '15%' },
    ...
    STNG_QSTN_HEADER: [
      { text: '번호', value: 'ROW_NUMBER', width: '50px' },
      { text: '문의유형명', value: 'QSTN_TYPE_NM', width: '30%' },
      { text: '문의유형 타입', value: 'QSTN_TYPE_CD_NM', width: '30%' },
      { text: '문의유형 레벨', value: 'QSTN_TYPE_SE_CD'},
