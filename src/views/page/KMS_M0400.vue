      ...
      <div class="pl-card-body">
        <div class="pl-grid-top pt-2">
          <div class="pl-grid-top-left">
            <v-btn class="pl-btn is-icon is-trans" @click="detailView">
        ...
        <v-data-table
          ...
          <template v-slot:item.RVW_CNT="{ item }">
            <compo-tooltip-btn v-if="parseInt(item.RVW_CNT) > 0" 
              TitleProp="요청 의견 보기" ClassProp="pl-tooltip-btn" IconProp="pl-icon20 document"
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: '지식 분류', value: 'FULL_PATH', width: '350px', align: 'left', sortable: false },
        ...
        { text: '요청 의견', value: 'RVW_CNT', align: 'center', width: '90px', sortable: false },
      ...
      headersExcel: [
        ...
        { text: '지식 ID', value: 'KMS_CONTS_ID', align: 'center', width: '90px', sortable: false },
        { text: '지식 구분', value: 'SE_NM', align: 'center', width: '130px', sortable: false },
        { text: '지식 콘텐츠', value: 'KMS_CONTS_NM', align: 'left', width: '400px', sortable: false},
