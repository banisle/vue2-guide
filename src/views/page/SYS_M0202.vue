      ...
      <div class="">
        <div class="pl-grid-top">
          <div class="pl-grid-top-left">
            ...
            <v-btn class="pl-btn is-icon is-sub" v-if="$store.getters['userStore/GE_USER_ROLE'].userId == '1'"
...
export default {
  name: "MENU_SYS_M0202", //name은 'MENU_' + 파일명 조합
  mixins: [gibberish],
  components: {},
  data() {
    return {
      ...
      headers: [
        ...
        {text: '센터', value: 'CO_NM', width: '100px'},
        {text: '사용자명', value: 'USER_NM', width: '150px'},
        {text: '사번', value: 'LGN_ID', width: '100px'},                     // 채번되어 들어가는 USER_ID가 아니라 LGN_ID를 표시
        {text: '소속', value: 'DEPT_WHOL_PATH'},
        ...
        {text: '최종수정일', value: 'MDFCN_DT', width: '100px'},
      ],
      MESSAGE: {
        CONFIRM: {
          REGIST: {
...
// console.log('this.this.USER_PARAMS', this.USER_PARAMS)
    ...
    */
    ...
    async forceResetPwdProc() {
      console.log('this.CHK_USER_GRID_ITEMS : ', this.CHK_USER_GRID_ITEMS);
      let arrUserId = [];
