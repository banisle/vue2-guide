  ...
  export default {
    ...
    data() {
      return{
        ...
        time_list: [
          ...
          { time: '10:00', active: false, disable: false },
          { time: '11:00', active: false, disable: true },
          { time: '12:00', active: false, disable: false },
          { time: '13:00', active: false, disable: true },
          { time: '14:00', active: false, disable: false },
          { time: '15:00', active: false, disable: true },
          { time: '16:00', active: false, disable: false },
          { time: '17:00', active: false, disable: false },
          { time: '18:00', active: false, disable: false },
          { time: '19:00', active: false, disable: false },
          { time: '20:00', active: false, disable: false },
        ],
    ...
    methods: {
      ...
      async vstRsvtProc() {
        ...
        console.log('this.INFO.VST_RSVT_ID : ', this.INFO.VST_RSVT_ID);
        if (!response.HEADER.ERROR_FLAG){
