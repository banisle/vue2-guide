  ...
  <div class="pl-container">
      ...
      <div class="pl-cols flex-grow-1">
        ...
        <div class="is-col-fix is-vrt" style="width: 500px">
          ...
          <div class="">
            ...
            <div class="pl-card-body pl-tree-body is-border-top" style="height: 680px;">
        ...
        <!-- right -->
        <v-form ref="gridForm">
          <div class="is-vrt d-flex flex-column">
            <div class="pl-card is-border-bottom">
              ...
              <div class="pl-search-form is-mt-m pb-0">
                <div class="pl-form-inline-wrap">
                  <div class="pl-form-inline">
                    ...
                    <div class="pl-desc">
                      <v-select class="pl-form type-middle" v-model="CONTS.STTS_CD" :items="contsSttsCdDropItems" placeholder="콘텐츠 상태"></v-select>
                    </div>
                  </div>
                  <div class="pl-form-inline">
                    <span class="pl-label">
                    ...
                    <div class="pl-desc">
                      <v-select class="pl-form type-middle" v-model="CONTS.SE_CD" :items="contsSeCdDropItems" placeholder="지식 구분"></v-select>
                    </div>
                  </div>
                  <div class="pl-form-inline">
                    <span class="pl-label">
            ...
            <div class="pl-card pt-2 pb-0">
              <div class="pl-grid-top">
                <div class="pl-grid-top-left">
                  <v-btn class="pl-btn is-icon is-trans"
                    :disabled=" ( CONTS.ITEMS.length < 1 ) "
                    @click="detailView">
    ...
    <v-dialog v-if="dialogReview" v-model="dialogReview" content-class="dialog-draggable is-scroll" hide-overlay>
      ...
      <compo-dialog header-title="검토 이력" @hide="mixin_hideDialog('Review')">
        ...
        <template slot="footer">
          <v-btn class="pl-btn is-trans" @click="mixin_hideDialog('Review')">닫기</v-btn>
        </template>
      </compo-dialog>
    </v-dialog>
    <!-- 지식 콘텐츠 등록 -->
      ...
      <compo-dialog
        ...
        <template slot="body">
          <KMS_M0301_DLG_REG_CONTENT
            ...
            ref="KmsRegContent"
            :EDITABLE_PROP="CONTS.IS_PIC_DISABLED"
            :KMS_CONTS_ID="CONTS_INFO.KMS_CONTS_ID"
            :KMS_CLSF_INFO="selectedNode">
          </KMS_M0301_DLG_REG_CONTENT>
        </template>
        <template slot="footer">
          <v-btn class="pl-btn is-trans" @click="colseContentDialog">닫기</v-btn>
          <v-btn class="pl-btn" @click="saveContent" :disabled="CONTS.IS_PIC_DISABLED">저장</v-btn>
        </template>
      </compo-dialog>
    </v-dialog>
  ...
  methods: {
    ...
    srch_tree_act( node ){
      ...
      if( this.selectedNode ) {
        ...
        this.CONTS.IS_PIC_DISABLED = "Y"!==this.selectedNode.PIC_USE_YN;
        console.log("this.CONTS.IS_PIC_DISABLED", this.CONTS.IS_PIC_DISABLED)
