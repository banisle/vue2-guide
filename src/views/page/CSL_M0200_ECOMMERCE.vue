  ...
  <div class="pl-card d-flex flex-grow-1 flex-column">
    ...
    <div v-if="!demoVideoMode"
      ...
      >
        ...
        <img v-if="BBS_CUTT_INFO.ULD_IMG_URL" :src="BBS_CUTT_INFO.ULD_IMG_URL" alt="게시판 문의 이미지"
...
export default {
  ...
  methods: {
    ...
    async openGoodsModal() {
      ...
      if(!this.mixin_isEmpty(this.bbsLkagList.ordrParam)){
        console.log("this.bbsLkagList.ordrParam", this.bbsLkagList.ordrParam)
...
console.log("postParam", postParam)
      ...
      if (!response.HEADER.ERROR_FLAG) {
        if (type === "regParam") {
          ...
          console.log("response.DATA2[0]", response.DATA2[0])
  ...
  watch: {
    ...
    BBS_CUTT_INFO() {
      this.selectBbsParam();
      console.log("BBS_CUTT_INFO I  ", this.BBS_CUTT_INFO)
    },
    USER_CUTT_STAT() {
