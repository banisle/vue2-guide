  ...
  <div class="pl-container">
    <div class="pl-card-wrap">
      ...
      <div class="pl-cols flex-grow-1 fill-height">
        ...
        <!-- right -->
        <div class="is-col-fix is-vrt fill-height" style="width: 610px">
          <div class="pl-card">
...
data() {
   return {
    ...
    headers: [
      ...
      { text: '휴일', value: 'NEW_HLDY_YMD', align: 'center', width: '120px' , sortable: false},
      { text: '휴일명', value: 'HLDY_NM', sortable: false},
      { text: '휴일구분', value: 'HLDY_SE_CD_NM', width: '120px' , sortable: false},
      { text: '등록자', value: 'RGTR_NM', width: '120px' , sortable: false},
      { text: '등록일', value: 'NEW_REG_DT', width: '120px' , sortable: false},
    ],
    items: [],
    ...
    MESSAGE : {
      CONFIRM : {
        ...
        , SAT_REG : {alertDialogToggle: true, msg: '1년동안의 모든 토요일이 추가됩니다<br>토요일을 추가하시겠습니까?', iconClass: 'is-info', type: 'confirm', callYes: this.satReg, callNo: this.closeMsg}
