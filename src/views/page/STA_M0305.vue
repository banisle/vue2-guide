  ...
  <div class="pl-container type-stat">
    <div class="pl-card-wrap">
      ...
      <div class="pl-card">
        ...
        <v-data-table
          class="pl-grid is-rowspan is-line"
  ...
  data() {
    return {
      ...
      gridDataHeaders: [
        ...
        { text: "상담건 대기", align: "center", value: "NEW_ALTMNT_AVG_HR",  width: '181px', sortable: false},
        { text: "포기건 대기", align: "center", value: "NEW_GIVEUP_AVG_HR",  width: '181px', sortable: false},
        { text: "상담시간", align: "center", value: "NEW_CUTT_AVG_HR",  width: '181px', sortable: false},
        { text: "후처리시간", align: "center", value: "NEW_AFTPRCS_AVG_HR",  width: '181px', sortable: false},
        { text: "처리시간", align: "center", value: "NEW_PRCS_AVG_HR",  width: '181px', sortable: false},
      ],
      gridDataText: [],
    }
  },
