      ...
      <div class="pl-cols fill-height ">
        ...
        <div class="is-col-fix is-vrt" style="width: 500px">
          ...
          <div class="is-border-top">
            ...
            <div class="pl-card-body pl-tree-body" style="height: calc(-317px + 100vh);">
              <v-treeview
                ref="treeDefault"
                :items="MENU_TREE"
                :open-all="expanded"
          ...
          <div
            class="pl-card is-border pl-btn-group d-flex">
            <!-- new folder 버튼 -->
            <compo-tooltip-btn
        ...
        <!-- center -->
        <div class="is-col-fix is-vrt fill-height flex-grow-1" >
          <div class="pl-card">
          ...
          <v-form ref="form_menu" class="pl-card is-noborder pt-0 flex-grow-1" style="overflow: auto; height: 609px;">
          ...
          <div
            ...
            class="spacing-wrap sp-4 pl-card is-border">
            <v-btn
        ...
        <div
          ...
          <div class="pl-card">
            ...
            <v-data-table
              ...
              class="pl-grid has-control type-hover-func is-mt-s"
              :headers="BTN_HEADER"
              :items="BTN_LIST"
          ...
          <div class="pl-card is-noborder flex-grow-1">
            ...
            <v-form ref="form_btn">
            <div class="pl-form-inline-wrap vertical is-mt-m label-80">
              <div class="pl-form-inline">
                <span class="pl-label">
                  메뉴 ID
                </span>
          ...
          <div
            v-if="$store.getters['userStore/GE_USER_ROLE'].userId == '1'"
            class="pl-card is-border spacing-wrap sp-4">
            <v-btn
              class="pl-btn is-icon is-trans"
...
<script>
  export default {
  name: "MENU_SYS_M0301", //name은 'MENU_' + 파일명 조합
  components: {
  },
  data() {
    return {
