  ...
  <div class="pl-card-body">
    ...
    <div class="pl-pager">
      ...
      <span class="pl-pager-period">
        보기 {{ mixin_getPagePeriod(OLD_AS_HIST, page) }} / {{ totalCount }}
        <!-- <compo-tooltip-btn
          TitleProp="다음 검색"
...
export default {
  name: 'CSL_M0503_TAB_02', //(구)AS 이력조회
  components: {
    CSL_M0503_SRCH,
    CompoAsFlwAcpDetail
  },
  data() {
    return {
      ...
      headers2: [
        ...
        { text: '중공종', value: 'MCLS_NM', align: '', width: '', sortable: false },
        { text: '소공종', value: 'SCLS_NM', align: '', width: '', sortable: false },
      ],
      items2: [
        {
          index: 29,
          type01: '240620-21-10004',
          type02: '대상',
          type03: '접수(이관)',
          type04: '',
          type05: '5152888517',
      ...
      table_head: [
        ...
        { text: '중공종', value: 'MCLS_NM', align: 'left', width: '150', sortable: false },
        { text: '소공종', value: 'SCLS_NM', align: 'left', width: '150', sortable: false },
  ...
  methods: {
    ...
    async searchOldAsHist(next = '') {
      ...
      if (!response.HEADER.ERROR_FLAG) {
        this.OLD_AS_HIST =  [...this.OLD_AS_HIST, ...response.DATA];
    ...
    async excelDown() {   
      ...
      if (!response.HEADER.ERROR_FLAG) {
        ...
        this.sheet_name = "(구)AS 이력";//mixin_common_exportExcel_all 에서 초기화 하여 다시 선언.
