      ...
      <div class="pl-grid-top pt-2">
        ...
        <div class="pl-grid-top-utils">
          ...
          <compo-excel
              ...
              :FileNameProp="`상담사별통계_월별_${SRCH_YEAR}`"
              SheetNameProp="상담사별통계_월별"
...
<script>
export default {
  name: 'STA_M0200_MONTHLY_STATS', //월별 통계
  components: {
  },
  data() {
    return {
...
console.log("⭐⭐⭐ > ",this.headersExcel)
  ...
  methods: {
    async getStatisticsMonthly(){
      this.isLoading=true;
      let sUrl = '/api/biz/common/select/selectStatsUserMonthly'
