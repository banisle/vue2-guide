            ...
            <div class="pl-cols" style="height: 100%;">
              <div class="is-col-fix is-vrt" style="width: 500px;">
                ...
                <v-form ref="contentInfo">
                  <div class="pl-card is-noborder pl-scroll-body"  style="height: calc(100vh - 200px);">
                    <!-- 분류 정보 -->
                    <div class="pl-chatting-cs-info ">
                      <div class="pl-chatting-cs-info-manager">
                          <div class="d-flex">
                            <strong class="pl-chatting-cs-info-tit">분류</strong>
                    ...
                    <div>
                      ...
                      <div class="pl-form-inline-wrap vertical label-80 type-kms is-mt-m">
                              ...
                              <v-chip-group active-class="active-tag" column>
                                ...
                                <template>
                                  ...
                                  <v-text-field
                                    ...
                                    placeholder="키워드 입력"
                                    class="pl-form is-tag type-middle">
          ...
          <v-tab-item transition="fade-transition">
            <div class="pl-card">
              ...
              <div class="pl-grid-top">
                <strong class="pl-bullet-txt is-blue">관련 콘텐츠 정보</strong>
              ...
              <div class="pl-grid-top is-mt-m">
                <strong class="pl-bullet-txt is-blue">관련 링크 정보</strong>
                <div class="pl-btn-wrap ml-auto">
                  <!-- 삭제 버튼 -->
                  <compo-tooltip-btn
                    TitleProp="삭제"
              ...
              <div >
                <v-form ref="relLink">
                  <v-data-table
                  class="pl-grid type-hover-func has-control is-mt-s"
              ...
              <div class="pl-grid-top is-mt-m">
                <strong class="pl-bullet-txt is-blue">첨부파일</strong>
                <div class="pl-btn-wrap ml-auto">
                  <!-- 삭제 버튼 -->
                  <compo-tooltip-btn
                    TitleProp="삭제"
  ...
  methods: {
    ...
    async applyTemplate() {
        if( !this.mixin_isEmpty(this.$refs.dlgTemplate.seletedTemplateCN()) ){
          let cn = await this.restoreXSS(this.$refs.dlgTemplate.seletedTemplateCN());
          this.crosseditor_initial_value = cn;
          this.$refs.crossEditor.setValue(cn);
          this.editData = await this.$refs.dlgTemplate.seletedTemplateCN();
    ...
    async getContent() {
      if(this.CONTENT_INFO.KMS_CONTS_ID && this.CONTENT_INFO.KMS_CONTS_ID != '') {
        ...
        if(resData.HEADER != undefined && !resData.HEADER.ERROR_FLAG) {
          ...
          let cn = this.restoreXSS(this.CONTENT_INFO.KMS_CONTS_CN);
          this.crosseditor_initial_value = cn;
          if(this.CONTENT_INFO.SE_CD == 'KNOWLEDGE' && this.isInitCompleted) {
            this.$refs.crossEditor.setValue(cn);
          }
          this.editData = this.CONTENT_INFO.KMS_CONTS_CN;
    ...
    saveContentValid() {
      ...
      if(this.CONTENT_INFO.SE_CD == 'KNOWLEDGE'){
    ...
    async saveContent(){
      ...
      const postParam = {
        ...
        COMM_YN : 'Y',
        KMS_CONTS_CN : this.CONTENT_INFO.SE_CD == 'KNOWLEDGE' ? this.$refs.crossEditor.getValue().replaceAll('\r\n','').replaceAll('\r','').replaceAll('\n','') : this.editData,
