<template>
  <div style="flex: 1 1 28%;">
    <div class="d-flex align-center">
      <strong class="pl-card-intop--title">나의 상담 현황</strong>
    </div>
    <div class="pl-cols" style="height: calc(100% - 22px);">
      <div class="pl-rounded-box is-mt-s px-5 py-4 is-col-fix" style="width: 30%" >
        <div class="d-flex align-center">
          ...
          <div class="ml-auto mr-2">
            ...
            <div class="d-flex flex-column" style="width: 150px">
              <div
                ...
                <span class="ml-auto text-right" style="width: 40px">
      ...
      <!-- 최근 1주일 상담 현황 -->
      <HomeManagerStatWeek class="ml-6" />
    </div>
  </div>
</template>

<script>
import HomeManagerStatWeek from './HomeManagerStatWeek.vue'
