           ...
           <div class="">
             <div class="pl-grid-top pt-2">
               <div class="pl-grid-top-left">
                 <v-btn class="pl-btn is-icon is-trans" @click="regTemp">
                   <span class="pl-icon20 circle-plus"></span>
                   등록
                 </v-btn>
                 <v-btn class="pl-btn is-icon is-trans" @click="delValid" :disabled="VO.checkedItems.length != 0 ? false : true">
         ...
         <div class="is-vrt d-flex flex-column" >
           ...
           <v-form ref="form" class="pl-card flex-grow-1">
             <div class="">
               ...
               <div class="pl-form-inline-wrap label-80 is-mt-m ">
                 <div class="pl-form-inline" style="width: 200px;">
                   <span class="pl-label">
                     템플릿 유형
                   </span>
                   <div class="pl-desc">
               ...
               <div class="pl-form-inline-wrap label-80 is-mt-s">
                 <div class="pl-form-inline" style="width:100%">
                   ...
                   <div class="pl-desc">
                     <v-text-field
                       ...
                       v-model="VO.temp_vo.KMS_TMPL_NM"
                       required
                       v-byte-counter="200"
                     >
                     </v-text-field>
  ...
  data() {
     return {
       ...
       grid : {
         ...
         headers: [
           ...
           { text: '등록자', value: 'RGTR_NM', align: 'center', width: '90px' },
       ...
       MESSAGE : {
         ...
         ALERT : {
             NOT_SELECT: {alertDialogToggle: true, msg: '삭제할 항목을 선택.', iconClass: 'is-info', type: 'default'}
   ...
   methods: {
     ...
     regTemp() {
         ...
         this.$refs.crossEditor.setValue('');
     ...
     async saveTemp() {
       ...
       postParam.KMS_TMPL_NM = this.VO.temp_vo.KMS_TMPL_NM;
       postParam.KMS_TMPL_CN = this.$refs.crossEditor.getValue().replaceAll('\r\n','').replaceAll('\r','').replaceAll('\n','');
     ...
     async selectItem(item) {
       ...
       if(!resData.HEADER.ERROR_FLAG) {
         ...
         let cn = this.restoreXSS(this.VO.temp_vo.KMS_TMPL_CN);
