  ...
  <div class="pl-card-body">
    ...
    <div class="pl-grid-top pt-2">
      ...
      <div class="pl-grid-top-utils">
        ...
        <compo-excel
          ...
          :DataBodyProp="NEW_UNTARGET_LIST"
          :FileNameProp="'(신)미대상조회-'+this.$moment(new Date()).format('YYYYMMDDHHmmss')"
          :SheetNameProp="'(신)미대상조회'"
        />
      </div>
    </div>
    <!-- grid -->
    ...
    <div class="pl-pager">
      ...
      <span class="pl-pager-period">
        보기 {{ mixin_getPagePeriod(NEW_UNTARGET_LIST, page) }} / {{ totalCount }}
        <!-- <compo-tooltip-btn
          TitleProp="다음 검색"
...
export default {
  ...
  data() {
    return {
      ...
      headers2: [
        ...
        { text: '업체', value: 'FRM_NM', align: '', width: '10%', sortable: false },
        { text: '접수채널', value: 'ACP_CHNL_NM', align: '', width: '4.5%', sortable: false },
        ...
        { text: '공종', value: 'MNTN_FLW_CS_NM', align: '', width: '8%', sortable: false },
      ...
      headersExcel: [
        ...
        { text: '업체', value: 'FRM_NM', align: 'left', width: '300', sortable: false },
        ...
        { text: '공종', value: 'MNTN_FLW_CS_NM', align: 'left', width: '450', sortable: false },
  ...
  methods: {
    ...
    async search(searchCondition = '') {
      ...
      this.searchNewUntargetList();
    },

    //페이지 클릭
    handlePage( p ) {
      this.pagination.page = p;
      this.searchNewUntargetList("next");
    },

    //(신)미대상 조회
    async searchNewUntargetList(next = '') {
      this.chkSelected = [];
      console.log("(신)미대상 조회 search", this.searchCondition)
      //다음버튼 클릭 유무
      if (next == 'next'){
        this.NEW_UNTARGET_LIST = [];
      } else {
        this.NEW_UNTARGET_LIST = [];
        this.totalCount = 0;
        this.pageCount = 0;
      ...
      if (!response.HEADER.ERROR_FLAG) {
        this.NEW_UNTARGET_LIST =  [...this.NEW_UNTARGET_LIST, ...response.DATA];
