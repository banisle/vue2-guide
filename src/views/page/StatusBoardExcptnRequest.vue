  ...
  <div class="py-5">
        ...
        <div class=" px-5 py-3 is-border-top">
          <div class="pl-form-inline-wrap label-80">
            <div class="pl-form-inline">
              ...
              <v-btn class="pl-btn" @click="getCustExcptnList('')">조회</v-btn>
            </div>
          </div>
        </div>
      </div>
          ...
          >
            ...
            <div class="">
              ...
              <div class="pl-btn-wrap is-mt-s">
                <v-btn class="pl-btn is-sm ml-auto" @click="getCustExcptnList('')">조회</v-btn>
              </div>
            </div>
          </v-menu>
        </template>
    ...
    <div
      ...
      <div v-if="!nextDisabled" class="d-flex justify-center is-mt-m pb-3">
        <v-btn class="pl-btn is-round is-sub px-4" @click="getCustExcptnList('next')">더보기</v-btn>
      </div>
    ...
    <v-slide-x-reverse-transition>
      <div
        ...
        <StatusBoardSlideDetail
          ...
          :CUST_EXCPTN_CN_ID="selectedItem.CUST_EXCPTN_CN_ID"
          :PropStat="STAT_LIST"
          PropType="excptnRequest"
          @Close="closeSlide"
...
export default {
  name: "StatusBoardExcptnRequest", //name은 'MENU_' + 파일명 조합
  components: {
    StatusBoardSlideDetail
  },
  props:{
  ...
  async created() {
    ...
    this.getCustExcptnList(''); //요청 목록
  },
  methods: {
    //요청 목록
    async getCustExcptnList(next) {
      let postParam = {
