      ...
      <div class="pl-cols" style="height: 100%">
        ...
        <div class="" >
          <div class="is-border-bottom">
            <v-tabs class="pl-tabs px-5 is-noborder" v-model="tab" @change="tabChg">
              <v-tab>접수지연 설정</v-tab>
              <v-tab>응대지연 설정</v-tab>
          ...
          <div class="is-border-right" style="height: calc(100vh - 191px)">
            <v-tabs-items v-model="tab" class="pl-tabs-items">
              <!-- 접수지연 설정 -->
              <v-tab-item>
                <div class="pl-card-body pt-4">
                ...
                <div class="pl-card-body is-mt-l">
                  <div style="width: 894px">
                    <div>
                      <h2 class="pl-subtit">상담 종료 메시지</h2>
                      <div class="pl-form-inline-wrap vertical is-mt-s label-80">
                        <div class="pl-form-inline flex-grow-1">
                          ...
                          <div class="pl-desc">
                            <v-text-field
                              ...
                              class="pl-form flex-grow-1 is-auto type-middle"
                      ...
                      <div v-for="(item,delayIndex) in DELAY_MSG" :key="delayIndex" class="is-mt-m">
                        <h2 class="pl-subtit">({{ item.ROW_NUMBER }}차) 접수 지연 메시지</h2>
                        <div class="pl-form-inline-wrap vertical is-mt-s label-80">
                          <div class="pl-form-inline">
                            ...
                            <div class="pl-desc">
                              <v-text-field
                                v-model="item.MSG_HR"
                                class="pl-form is-sm flex-grow-0 type-middle"
                                suffix="분"
                                type="number"
                  ...
                  <div style="width: 894px">
                    <div>
                      ...
                      <div v-for="(item,delayResponseIndex) in DELAY_RESPONSE_MSG" :key="delayResponseIndex" class="is-mt-m">
                        <h2 class="pl-subtit">({{ item.ROW_NUMBER }}차) 응대 지연 메시지</h2>
                        <div class="pl-form-inline-wrap vertical is-mt-s label-80">
                          <div class="pl-form-inline">
                            <span class="pl-label">
                              지연 시간
                  ...
                  <div style="width: 894px">
                    <div>
                      ...
                      <div v-for="(item,delayNoResponseIndex) in DELAY_NO_RESPONSE_MSG" :key="delayNoResponseIndex" class="is-mt-m">
                        <h2 class="pl-subtit">({{ item.ROW_NUMBER }}차) 고객 무응답 메시지</h2>
                        <div class="pl-form-inline-wrap vertical is-mt-s label-80">
                          <div class="pl-form-inline">
                            <span class="pl-label">
                              지연 시간
        ...
        <!-- 미리보기 -->
        <div class="is-vrt is-col-fix is-border-top" style="width: 450px; margin-top: 45px;">
          <div class="pl-card">
            <h2 class="pl-subtit">미리보기</h2>
          </div>
          <div class="pl-phone-bg-wrap mt-12">
...
<script>
export default {
name:"MENU_SYS_M0601", //name은 'MENU_' + 파일명 조합
components: {
},
data() {
   return {
