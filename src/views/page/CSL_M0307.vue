          ...
          <div class="is-vrt">
            <v-tabs-items v-model="tab" class="pl-tabs-items">
              ...
              <v-tab-item>
                ...
                <!-- grid -->
                <div class="">
                  <div class="pl-grid-top is-border-top">
    ...
    return {
      ...
      */
      ...
      PHONE_LOG_HISTORY_HEADER: [
        { text: '번호', value: 'ROW_NUMBER', align: 'center', width: '90px' ,sortable: true},
      ...
      */
      ...
      SNS_LOG_HISTORY_HEADER: [
        { text: '번호', value: 'ROW_NUMBER', width: '90px', align: 'center',sortable : false },
