      ...
      <div class="pl-grid-top pt-2">
        ...
        <div class="pl-grid-top-utils">
          ...
          <compo-excel
              ...
              :FileNameProp="`상담사별통계_시간별_${srchParam.srchStartDt.replaceAll('-','')}_${srchParam.srchEndDt.replaceAll('-','')}`"
              SheetNameProp="상담사별통계_시간별"
	...
	no-data-text="등록된 데이터가 없습니다."
        ...
        <template v-slot:item="{ item, index }">
          <tr
            ...
            <td class=""> {{ item.USER_NM + " [ " + item.USER_ID + " ]" }} </td>
...
<script>
export default {
  name: 'STA_M0200_HOURLY_STATS', //시간별 통계
  components: {
  },
  data() {
    return {
      ...
      headersRowSpan: [
        { text: '팀', value: 'TEAM_NM', align: '', width: '8%', sortable: false },
        { text: '상담원', value: 'USER_NM', align: '', width: '8%', sortable: false },
  ...
  methods: {
    async getStatisticsHourly(){
      this.isLoading=true;
      let sUrl = '/api/biz/common/select/selectStatsUserHourly'
