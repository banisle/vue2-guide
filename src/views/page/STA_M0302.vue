          ...
          <template v-slot:header>
            <thead class="v-data-table-header multi-row">
              <tr>
                ...
                <th colspan="4" width="630px" class="text-center"><span>문의유형</span></th>
  ...
  data() {
    return {
      ...
      headersRowSpan: [
        ...
        { text: "1LEVEL", align: "left", value: "LV1",  width: '150px' ,sortable: false},
        { text: "2LEVEL", align: "left", value: "LV2",  width: '150px' ,sortable: false},
        { text: "3LEVEL", align: "left", value: "LV3",  width: '150px' ,sortable: false},
        { text: "4LEVEL", align: "left", value: "LV4",  width: '150px' ,sortable: false},
