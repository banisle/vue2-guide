<template>
  <div class="pl-container">
    <div class="pl-card-wrap">
      ...
      <!-- sub content -->
      <div class="pl-card-body pl-scroll-body py-5"  style="height: calc(100vh - 147px);">
        <!-- 고객 접수 설정 -->
              ...
              >
                <v-radio class="pl-radio" value="Y">
                  <template v-slot:label>
                    사용
                    <v-select
                      class="pl-form is-sm ml-1 type-middle"
...
<script>
export default {
name:"MENU_SYS_M0608", //name은 'MENU_' + 파일명 조합
components: {
},
data() {
  return {
      ...
      if(!resData.HEADER.ERROR_FLAG){
        ...
        for(let i=0;i<leng;i++){
          if(resData.DATA[i].STNG_CD == "ROUTE_CD"){  //고객접수설정(배분상태)
            ...
            this.SHOW_QSTN = resData.DATA[i].STNG_VL
