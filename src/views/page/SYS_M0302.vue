            ...
            <div class="pl-cols" style="height: 100%">
              ...
              <div class="is-col-fix" style="width: 510px">
                ...
                <div class=" d-flex flex-column">
                  <v-form ref="form">
                  <div class="pl-card" style="overflow: auto; height: calc(100vh - 329px); ">
                      ...
                      <div class="pl-form-inline">
                        ...
                        <div class="pl-desc">
                          <v-select
                            ...
                            :disabled="AUTHRT_GROUP_ID != '' "
                            :rules="validateRules.SCH_CUSTCO_ID"
                          ></v-select>
                        </div>
                      </div>
                      <div class="pl-form-inline">
            ...
            <div class="pl-cols" style="height: 100%">
              ...
              <div class="is-col-fix is-vrt" >
                ...
                <div class="fill-height d-flex flex-column">
                    ...
                    <div class="pl-cols">
                      <div>
                        <div class="pl-subdesc d-flex justify-space-between">
                          <strong class="pl-bullet-txt is-blue">설정되지 않은 메뉴</strong>
                          <span class="pl-counter">전체 <em class="pl-1 is-txt-blue">({{ UN_STNG_MENU_ITEMS.length }})</em> 건</span>
                        </div>
                        <v-data-table
                          class="pl-grid has-control is-mt-s is-border-top"
                      ...
                      <div class="spacing-wrap px-4 flex-column justify-center align-center " style="flex: 0 0 58px;">
                      ...
                      <div>
                        <div class="pl-subdesc d-flex justify-space-between">
                          <strong class="pl-bullet-txt is-blue">설정된 메뉴</strong>
                          <span class="pl-counter">전체 <em class="pl-1 is-txt-blue">({{ STNG_MENU_ITEMS.length }})</em> 건</span>
                        </div>
                        <v-data-table
                          class="pl-grid has-control is-mt-s is-border-top"
                  ...
                  <div class="pl-card pl-card-body py-4 is-border text-right">
                    <v-btn
                      class="pl-btn"
              ...
              <div
                v-if="btnAuthority"
                class="is-vrt d-flex flex-column"
                style="flex: 0 0 30%"
                >
                <div class="pl-card flex-grow-1">
                  ...
                  <div class="pl-grid-top px-0">
                    <strong class="pl-bullet-txt is-blue">부여되지 않은 버튼</strong>
                    <span class="pl-counter">전체 <em class="pl-1 is-txt-blue">({{ UN_STNG_BTN_ITEMS.length }})</em> 건</span>
                  </div>
                  <v-data-table
                    class="pl-grid has-control is-mt-s"
                  ...
                  <div class="d-flex justify-center align-center is-mt-m">
                    ...
                    <compo-tooltip-btn
                      ...
                      :MinWidthProp="36"
                      :HeightProp="36"
                      IconProp="pl-icon30 arrow-up-list"
                      TooltipPositionProp="bottom"
                    ...
                    <compo-tooltip-btn
                      ...
                      :MinWidthProp="36"
                      :HeightProp="36"
                      IconProp="pl-icon30 arrow-down-list"
                      TooltipPositionProp="bottom"
                      @btnClick="stng_btn()"
                  ...
                  <div class="pl-grid-top px-0">
                    <strong class="pl-bullet-txt is-blue">부여된 버튼</strong>
                    <span class="pl-counter">전체 <em class="pl-1 is-txt-blue">({{ STNG_BTN_ITEMS.length }})</em> 건</span>
                  </div>
                  <v-data-table
                    class="pl-grid has-control is-mt-s"
...
export default {
  ...
  data() {
    return {
      ...
      ROW_PER_PAGE: 15,
      AUTHRT_GROUP_HEADER: [
        { text: '번호', value: 'RNUM', align: 'center', width: '50px' },
        { text: '센터명', value: 'CUSTCO_NM', width: '8%' },
        { text: '권한그룹ID', value: 'AUTHRT_GROUP_ID', width: '8%' },
        { text: '권한그룹명', value: 'AUTHRT_GROUP_NM', width: '12%'},
        { text: '메인메뉴개수', value: 'CNT_MAIN_MENU', width: '12%' },
        { text: '좌측메뉴개수', value: 'CNT_LEFT_MENU', width: '12%' },
        { text: '우측메뉴개수', value: 'CNT_RIGHT_MENU', width: '12%' },
        { text: '권한그룹설명', value: 'GROUP_EXPLN'},
        { text: '정렬순서', value: 'SORT_ORD', align: 'center', width: '10%' },
      ],
      AUTHRT_GROUP_ITEMS: [],
  ...
  methods: {
    ...
    setCustcoAuthrtGroupCombo() {
      ...
      this.AUTHRT_GROUP_ITEMS.forEach((item, index) => {
