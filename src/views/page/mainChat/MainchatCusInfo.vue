  ...
  <div :class="resizeClass ? 'expand' : ''">
    <div class="pl-card-top">
      <div
        ...
        >
        <img :src="custInfoProp.portrait" :alt="custInfoProp.CUST_NM" @error="function(e){e.target.src=require('@/assets/img/@profile_user.png')}">
      </div>
      <div class="ml-4">
      ...
      <template slot="body">
          ...
          <div class="pl-cols is-mt-l">
            <div>
              ...
              <div class="pl-scroll-body d-flex flex-column is-mt-m" style="overflow-y: scroll; height: calc(100vh - 450px); ">
                <div
