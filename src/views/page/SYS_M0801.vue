...
<script>
export default {
   name:"MENU_SYS_M0801", //시스템 로그 - name은 'MENU_' + 파일명 조합
...
data() {
  return {
    ...
    headers: [
      ...
      { text: '로그 구분', value: 'SE_NM', align: 'left', width: '300px' ,sortable : false},
      { text: '메뉴 경로', value: 'CNTN_MENU_PATH', align: 'left', width: '',sortable : false },
