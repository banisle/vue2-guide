            ...
            <div class="pl-cols flex-grow-1">
              ...
              <!-- right -->
                ...
                <div class="is-col-fix is-vrt" style="width: 510px">
                  ...
                  <div >
                    <div class="pl-card" style="overflow: auto; height: 597px; ">
                      <v-form ref="form">
...
data() {
   return {
    ...
    headers: [
      { text: '번호', value: 'ROW_NUMBER', align: 'center', width: '90px'},
      { text: '위치명', value: 'PSTN_NM', align: 'left', width: '150px'},
      { text: '지역', value: 'SPLIT_ADDR', align: 'left', width: '120px'},
      { text: '우편번호', value: 'ZIP', align: 'center', width: '120px'},
      { text: '주소', value: 'ADDR', align: 'left', width: ''},
      { text: '사용여부', value: 'USE_YN', align: 'center', width: '90px'},
      { text: '등록자', value: 'USER_NM', align: 'left', width: '120px'},
    ...
    headers2: [
      { text: '번호', value: 'ROW_NUMBER', align: 'center', width: '90px'},
      { text: '담당부서', value: 'TKCG_DEPT_NM', align: 'left', width: '120px'},
      { text: '담당업무', value: 'TASK_NM', align: 'left', width: ''},
      { text: '호전환 대상', value: 'PHN_TRAN_TRGT_YN', align: 'center', width: '120px'},
      { text: '지역', value: 'RGN_NM', align: 'left', width: '120px'},
      { text: '연락처', value: 'TELNO', align: 'left', width: '120px'},
      { text: '사용여부', value: 'USE_YN', align: 'center', width: '90px'},
      { text: '등록자', value: 'USER_NM', align: 'left', width: '120px' },
      { text: '등록일', value: 'REG_DT', align: 'center', width: '120px'},
    ],
