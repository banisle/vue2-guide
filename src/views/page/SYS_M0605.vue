      ...
      <div class="pl-card-body">
        <div class="pl-grid-top pt-2">
          <div class="pl-grid-top-left">
            ...
            <v-btn class="pl-btn is-icon is-trans" @click="[BF_MSG_HR='-1',initSysMsg(),mixin_showDialog('RegMsg')]">
...
<!--            <compo-tooltip-btn
    ...
    <v-dialog
      ...
      >
        <template slot="body">
          <v-form ref="form">
          <div class="pl-form-inline-wrap vertical mt-2 label-80">
            <div class="pl-form-inline">
              <span class="pl-label">
                메시지 분류
              </span>
            ...
            <div class="pl-form-inline">
              ...
              <div class="pl-desc">
                <v-select
                  class="pl-form flex-grow-0 type-middle"
        ...
        <template slot="footer">
          <v-btn class="pl-btn is-trans" @click="[initSysMsg(),mixin_hideDialog('RegMsg')]">닫기</v-btn>
          <v-btn
            class="pl-btn"
...
<script>
export default {
name:"MENU_SYS_M0605", //name은 'MENU_' + 파일명 조합
components: {
},
data() {
   return {
