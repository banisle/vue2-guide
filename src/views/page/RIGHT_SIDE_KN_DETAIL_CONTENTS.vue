<template>
  ...
  <div style="display: contents;">
    <!-- stle 변경 -->
    <div class="pl-right-kms-detail-content px-5" style="flex: 1;height: auto">
      <div v-html=" CONTENT_INFO.KMS_CONTS_CN_HMTL "
          class="pr-2">
        <div class="pl-tags-wrap is-mt-m pt-3 is-border-sub-top">
          <v-chip-group
        ...
        <template v-if=" !mixin_isEmpty(REL_CONTENT_LIST) && showRelConts">
          ...
          <ul class="pl-link-list is-mt-m mr-2">
            <li v-for="item in REL_CONTENT_LIST" :key="item.KMS_REL_CONTS_ID"
                @click="relContsClick(item.KMS_REL_CONTS_ID)">
    ...
    <div class="pl-quick-layer-footer" >
      <div class="d-flex align-center">
        <div class="ml-2 spacing-wrap sp-4">
          <v-btn class="pl-btn is-trans is-icon" >
...
<script>
export default {
  name: 'RIGHT_SIDE_KN_DETAIL_CONTENTS', //지식정보 컨텐츠 상세 내용
  components: {},
  props: {
  ...
  created() {
    this.initDetailData();
    if(!this.mixin_isEmpty(this.KMS_CONTS_ID)) this.getKmsContentInfo()
  },
  mounted() {
  },
  methods: {
