        ...
        <div class="pl-form-inline-wrap vertical is-mt-m label-80">
          ...
          <template v-if="CHN_CLSF_CD != 'EMAIL' && CHN_CLSF_CD != 'BBS'">
            ...
            <div class="pl-form-inline">
              <span
                class="pl-label">
                {{CHN_CLSF_CD != 'NTT' ? (CHN_CLSF_CD != 'MO' ? '발신 프로필 키' : '수발신 전화번호') : '보내기API (Authorization)'}}
              </span>
              <div class="pl-desc">
                <v-text-field
                  class="pl-form type-middle"
          ...
          <template v-if="CHN_CLSF_CD == 'EMAIL'">
            ...
            <div class="pl-form-inline">
              ...
              <div class="pl-desc">
                <v-select
                  class="pl-form type-middle"
                  :items="mixin_common_code_get_global(common_code_global, 'EMAIL_PROTOCOL_TP')"
                  placeholder="선택하세요"
...
data() {
  ...
  async created() {
    //공통코드설정
    let codeNameGloal = ['EMAIL_PROTOCOL_TP'/*이메일 연동 프로토콜콜*/];
