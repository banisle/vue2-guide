<template>
  <div>
    ...
    <div class="d-flex align-center is-mt-s px-5">
      <span class="pl-label">이첩반려 (<span class="is-txt-blue">{{ TRANS_TOT_CNT }}</span>)건</span>
      <compo-tooltip-btn
        TitleProp="새로고침"
    ...
    <div
      ...
      class="is-mt-s pl-notice-list arrow-type-up is-border-top pl-scroll-body">
      <div
        ...
        <div class="d-flex align-center">
          ...
          <div class="d-flex align-center flex-grow-1">
            <div class="ml-3">
              ...
              <div >
                <span>반려일시 {{ mixin_convertDate(item.REG_DT, 'yyyy-MM-dd HH:mm:ss') }}</span>
              </div>
            </div>
          </div>
        </div>
        <div
          ...
          <div class="pl-rounded-box pa-2 ml-12 " v-html="mixin_newLine(item.REQ_CNTNT)" />
        </div>
      </div>
...
<script>
export default {
  name: 'StatusBoardTrans_TAB_03', //이첩 반려
  components: {
  },
  data() {
    return {
