        ...
        <!-- <v-tabs-items v-model="tab" class="pl-tabs-items"> -->
          ...
          <!-- <v-tab-item> -->
            <div class="pl-cols fill-height" >
              <div class="is-col-fix is-vrt fill-height" style="width: 20.5%;">
                ...
                <div class="is-vrt is-col-fix " style="">
                  <div class="pl-card">
                    <!-- tree -->
                    ...
                    <div class="pl-tree-body" style="height: calc(-320px + 100vh)">
                      <v-treeview
                        ref="treeDefault"
              ...
              <!-- 미리보기 -->
              <div class="is-vrt is-col-fix d-flex flex-column" style="width: 450px">
                <div class="pl-card">
                ...
                <div class="pl-phone-bg-wrap is-mt-m flex-grow-1">
                ...
                <div class="pl-card spacing-wrap sp-4 is-border">
                  <v-btn
              ...
              <div class="is-vrt">
                <div class="pl-card">
                  ...
                  <div class="">
                    ...
                    <div class="pl-form-inline-wrap vertical is-mt-s">
                      <div class="pl-form-inline">
                        ...
                        <div class="pl-desc">
                          <v-text-field
                            class="pl-form flex-grow-1 type-middle"
                  ...
                  <div class="pl-btn-wrap text-right is-mt-m">
                    <v-btn
                      class="pl-btn is-sub ml-auto"
      ...
      <v-dialog
        ...
        >
          <template slot="body">
            <!-- component -->
            <div class="pl-cols" >
              <div class="is-vrt is-col-fix " style="width: 450px">
...
export default {
  name: "MENU_SYS_M0602", //name은 'MENU_' + 파일명 조합
  components: {
  },
  data() {
    return {
