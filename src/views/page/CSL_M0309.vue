      ...
      <div class="pl-card-body">
        ...
        <v-data-table
          ...
          <template v-slot:item.VSTR_NM="{ item }">
            <img
              v-if="item.VSTR_NM"
              :src="item.VSTR_ICON ? item.VSTR_ICON : require('@/assets/img/@profile_user.png')"
              :alt="`${ item.VSTR_NM  }`"
            ...
            <div class="pl-form-box-list-unit">
              <div
                ...
                <div class="pl-portait-img">
                  <img
                    :src="selectedRow.VSTR_ICON ? selectedRow.VSTR_ICON : require('@/assets/img/@profile_user.png')"
