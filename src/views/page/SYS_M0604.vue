      ...
      <div class="pl-card-body">
        <div class="pl-grid-top pt-2">
          <div class="pl-grid-top-left">
            ...
            <v-btn class="pl-btn is-icon is-trans" @click="openDialogRegist()">
...
export default {
name:"MENU_SYS_M0604", //name은 'MENU_' + 파일명 조합 - 메신저 연동 관리
components: {
  STG_M0504_DLG_DETAIL
},
data() {
   return {
    ...
    ROW_PER_PAGE: 15,
    headers: [
      { text: '번호', value: 'ROW_NUMBER', width: '90px', align: 'center' },
