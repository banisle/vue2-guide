<template>
  <div class="pl-login-frame">
    <div class="pl-login-form">
      ...
      <div class="pl-login-date">
        <DateClock format="M/DD (dddd) H:mm:ss"/>
      </div>

      <!-- 서브 로고 -->
      <div class="pl-form-inline-wrap vertical type-2 mt-4">
    ...
    <!-- temp: 로그인 선택 창 -->
    <div
      style="position: absolute; right: 0; bottom: 0; width: 80px; height: 80px;"
      @click="dialogTempUser = true"></div>
    <v-slide-x-transition>
      <div v-if=" dialogTempUser === true " class="pl-quick-layer type-right " style="height: calc(100vh - 150px)">
        <div class="pl-quick-layer-header">
          ...
          <compo-tooltip-btn
              ...
              @btnClick="dialogTempUser = false"
          ></compo-tooltip-btn>
        </div>
        <div class="is-mt-s pr-5 pl-3 py-3" style="overflow-y:scroll">
          <ul class="pl-list-dot is-no-border spacing-wrap sp-8 flex-column mt-0">
            <li class="d-flex align-center hover-bold"><span @click="uid = 'hkc#plt430'; upwd = '1111';" style="cursor: pointer;">hkc#plt430 로그인</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '891110'; upwd = '1111';" style="cursor: pointer;">운영관리자 - 인재개발팀(이미현)</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '886820'; upwd = '1111';" style="cursor: pointer;">운영관리자 - 운영지원팀(구연주)</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '880312'; upwd = '1111';" style="cursor: pointer;">마이홈 센터장 이혜경 </span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '886751'; upwd = '1111';" style="cursor: pointer;">전세통합센터 센터장 신영이 로그인</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '893183'; upwd = '1111';" style="cursor: pointer;">바로처리관리 센터장 전한국 로그인</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '886852'; upwd = '1111';" style="cursor: pointer;">주택지원센터 센터장 최소연 로그인</span></li>
            <li class="d-flex align-center hover-bold is-border-sub-top"><span @click="uid = '890820'; upwd = '1111';" style="cursor: pointer;">마이홈1팀 팀장(부팀장) 엄윤혜</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '880486'; upwd = '1111';" style="cursor: pointer;">마이홈2팀 팀장(부팀장)</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '894386'; upwd = '1111';" style="cursor: pointer;">마이홈1팀 상담사 김경미</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '896503'; upwd = '1111';" style="cursor: pointer;">마이홈2팀 상담사 김수미</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '886854'; upwd = '1111';" style="cursor: pointer;">공가해소1팀 최소영 팀장(부팀장)</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '891508'; upwd = '1111';" style="cursor: pointer;">공가해소2팀 최혜지 팀장(부팀장)</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '891474'; upwd = '1111';" style="cursor: pointer;">공가해소1팀 상담사 김희정</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '891504'; upwd = '1111';" style="cursor: pointer;">공가해소2팀 상담사 이은서</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '880613'; upwd = '1111';" style="cursor: pointer;">공가해소1팀 상담사 차천미</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '892831'; upwd = '1111';" style="cursor: pointer;">공가해소2팀 상담사 양연경</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '894299'; upwd = '1111';" style="cursor: pointer;">바로처리(인바운드) 바로처리9팀 상담사 임소희 로그인</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '893184'; upwd = '1111';" style="cursor: pointer;">바로처리(인바운드) 바로처리9팀 팀장(부팀장) 김수인 로그인</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '890797'; upwd = '1111';" style="cursor: pointer;">바로처리(인바운드-모니터링) 팀장(부팀장) 우동숙 로그인</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '887247'; upwd = '1111';" style="cursor: pointer;">바로처리(인바운드) 팀장(부팀장) 이현영 로그인</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '894430'; upwd = '1111';" style="cursor: pointer;">바로처리(스케줄러) 바로처리6팀 상담사 강귀옥 로그인</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '890800'; upwd = '1111';" style="cursor: pointer;">바로처리(스케줄러) 바로처리5팀 팀장(부팀장) 최순정 로그인</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '893395'; upwd = '1111';" style="cursor: pointer;">바로처리(스케줄러 모바일) 바로처리5팀 상담사 정혜은 로그인</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '891602'; upwd = '1111';" style="cursor: pointer;">전세임대센터 전세1팀(서울1) 팀장(부팀장) 고은정 로그인</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '895384'; upwd = '1111';" style="cursor: pointer;">전세임대센터 전세1팀(서울1) 상담사 문영미 로그인</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '890814'; upwd = '1111';" style="cursor: pointer;">전세임대센터 전세2팀(경기북부) 상담사 김연주 로그인</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '889830'; upwd = '1111';" style="cursor: pointer;">주택지원센터 렌트홈 팀장(부팀장) 고은정 로그인</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '886235'; upwd = '1111';" style="cursor: pointer;">주택지원센터 렌트홈 상담사 김연심 로그인</span></li>
            <li class="d-flex align-center hover-bold"><span @click="uid = '894626'; upwd = '1111';" style="cursor: pointer;">주택지원센터 렌트홈 상담사 김윤희 로그인</span></li>
          </ul>
        </div>
      </div>
    </v-slide-x-transition>
    ...
    <v-dialog
      ...
      >
        ...
        <template slot="footer">
          <v-btn class="pl-btn is-trans" @click="mixin_hideDialog('FindPass')">닫기</v-btn>
    ...
    <v-dialog
      ...
      >
        ...
        <template slot="footer">
          <v-btn class="pl-btn is-trans" @click="mixin_hideDialog('LoginFindMessageModel');">닫기</v-btn>
        </template>
      </compo-dialog>
    </v-dialog>
...
import DateClock from '@/components/compoClock.vue'
...
export default {
  ...
  data: () => ({
    dialogTempUser: false, //임시
    isLoginIdSave: false,
    //멀티테넌시 사용 여부
    IS_USE_MULTITENANCY: process.env.VUE_APP_MULTITENANCY_USE_YN === 'N' ? false: true,
    currentDomain : '',
    uid: "",
    upwd: "",
    ENCRYPT_KEY: "",
  ...
  mounted() {
    ...
    if(process.env.VUE_APP_ENV == 'production'
        && process.env.VUE_APP_API_URL.indexOf("172.30.115.219") == -1
        && process.env.VUE_APP_API_URL.indexOf("172.30.115.221") == -1
        && process.env.VUE_APP_API_URL.indexOf("172.30.115.222") == -1
        && process.env.VUE_APP_API_URL.indexOf("172.30.115.223") == -1
    ){ //LHCS통합개발서버가 아닌경우
  ...
  methods: {
    ...
    init() {
      ...
      if( loginCheckType === "true" || loginCheckType === true) {
        this.isLoginIdSave = true;
        this.uid = this.$cookies.get("loginId")?this.$cookies.get("loginId"):"";
        if(this.uid !== "") {
          this.$refs.upwd.focus();
        }
      }else {
        this.isLoginIdSave = false;
      }
    ...
    async getKey() {
      ...
      console.log("IS_USE_MULTITENANCY", this.IS_USE_MULTITENANCY);
      const isGetTenantKey = this.IS_USE_MULTITENANCY ? await this.getCertCustcoTenantId() : true;
        ...
        .then((response) => {
          if (this.mixin_check_repsonse(response) === true) {
            // setTimeout(() => {
              ...
              this.$cookies.set("loginCheckType", this.isLoginIdSave, "15d", "/", "", true, "Lax");
              if(this.isLoginIdSave){
                this.$cookies.set("loginId", this.uid, "15d", "/", "", true, "Lax");
              }else {
    ...
    setUserDedail() {
      ...
      this.$store
        ...
        .then((response) => {
          ...
          this.$store.dispatch("userStore/AC_SRC_DLGT_USER", {USER_ID: '', LGN_ID: ''});
          this.$store.dispatch('commonStore/AC_COMMON_LEADER_HOME_TAB', 0);
          this.$store.commit("statusStore/MU_FAVORIT_HIDDEN", !this.$store.getters['commonStore/GE_COMMON_CUTT_FAVORIT_HIDE_SHOW']);
        });
    },
    ...
    getCompany( obj ) {
      this.$store
        .dispatch("userStore/AC_USER_COMPANY_LIST", {
          user_id: obj.USER_ID
          , lgn_id: obj.LGN_ID
          , custco_id : obj.CUSTCO_ID
          , author_group_nm_list : obj.AUTHOR_GROUP_NM_LIST
        })
        .then((response) => {
          //사용자 상세정보 조회
