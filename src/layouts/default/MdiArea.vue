  ...
  <div class="pl-layout-tabs-area">
    ...
    <div class="is-right">
      ...
      <v-menu
        ...
        bottom
        left
        content-class="pl-layout-tabs-more pl-menu-drop"
        style="z-index: 9999"
      >
...
<script>
import DateClock from '@/components/compoClock'
...
export default {
  ...
  computed: {
    ...
    // tabs dragging
    draggingInfo() {
      return this.tabs_dragging ? "under drag" : "";
    },
    tabsDragList: {
      get() {
        return this.$store.getters["commonStore/GE_COMMON_TAB_ID"];
      },
      set(value) {
        this.$store.dispatch("commonStore/AC_COMMON_INIT_TAB", {
          id: value.id,
          title: value.title,
        });
      }
