      ...
      <div class="pl-header type-white">
        ...
        <div class="spacing-wrap sp-4 ml-auto align-center">
          ...
          <v-btn
            ...
            @click="mixin_openSearchWindow( 'LayoutSearchPopup', '1400', '890', {compo_name : 'CompoAsMgofInfo', title: '단지정보', popData: {ARA_HDQ_CD: selectedItem.ARA_HDQ_CD, MGOF_CD: selectedItem.MGOF_CD, MGOF_NM: selectedItem.MGOF_NM, BLDG_NO: FLW_ACP_INFO.BLDG_NO, HS_NO: FLW_ACP_INFO.HS_NO}})">단지정보</v-btn>
          <v-btn
            class="pl-btn is-sub is-sm"
            @click="mixin_openSearchWindow( 'LayoutSearchPopup', '1600', '771', {compo_name : 'CompoAsInitHist', title: '공용부 이력', popData: {ARA_HDQ_CD: selectedItem.ARA_HDQ_CD, MGOF_CD: selectedItem.MGOF_CD, MGOF_NM: selectedItem.MGOF_NM, BLDG_NO: FLW_ACP_INFO.BLDG_NO}})">공용부 이력</v-btn>
        ...
        <table class="pl-tbl-detail ">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <span
                  v-if="FLW_ACP_INFO.MSTATUS_CATE_CD == 'MOBILE' || FLW_ACP_INFO.MSTATUS_CATE_CD == 'PHONE'"
                  style="width: 110px"
                  :class="`pl-badge is-${mixin_displayStatus(FLW_ACP_INFO.MSTATUS_CATE_CD, 'MSTATUS_CATE_CLASS_LIST')}`">
                    {{ FLW_ACP_INFO.MSTATUS_CATE }}
                </span>
              </td>
            </tr>
          </tbody>
        ...
        <table class="pl-tbl-detail ">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="3" class="has-textarea">
                <v-textarea
                  v-model="FLW_ACP_INFO.CVPR_MEMO"
                  disabled
                  class="pl-form is-noresize"
                  :spellcheck="false"
                  height=80
            ...
            <tr>
              ...
              <td>
                <span
                  v-if="!mixin_isEmpty(FLW_ACP_INFO.SCH_STAT_TYPE)"
                  style="width: 110px"
                  :class="`pl-badge is-${mixin_displayStatus(FLW_ACP_INFO.SCH_STAT_TYPE, 'SCH_STAT_TYPE_CLASS_LIST')}`">
                    {{ FLW_ACP_INFO.SCH_STAT_TYPE_NM }}
                </span>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <v-text-field
                  v-model="FLW_ACP_INFO.VST_FIX_DT"
                  disabled
                  class="pl-form is-auto "
                ></v-text-field>
              </td>
            ...
            <tr>
              ...
              <td colspan="3" >
                <v-text-field
                  v-model="FLW_ACP_INFO.WORK_TYPE_NM"
                  disabled
                  class="pl-form is-auto "
                ></v-text-field>
              </td>
    ...
    <div class="pt-2 pr-3 pl-2 pb-3">
      ...
      <div class="is-mt-m">
        <div class="pl-header type-white">
          ...
          <div class="spacing-wrap sp-4 ml-auto">
            <v-btn
              v-if="FLW_ACP_INFO.MSTATUS != 'MSTATUS01'" 
              class="pl-btn is-sub is-sm"
              @click="btnPhoneToMobile">모바일전환</v-btn>
            <v-btn  class="pl-btn is-sub is-sm"
              @click="btnMobileToPhone">유선전환</v-btn>
            <v-btn class="pl-btn is-sub is-sm"
...
export default {
  name: "CompoAsSchedulerMobile_DETAIL", //스케쥴러 정보
  components: {
    CompoSendSms,
    CompoFindAsIcpr,
    CompoFindAsMultiSave,
  ...
  data() {
    return {
      //관리자여부 - 사용안함
      isAdmin: this.$store.getters['userStore/GE_USER_ROLE'].groupCd.indexOf("CNSLT_ADMIN") > -1 ? true : false,
      ...
      HOUR_LIST: [{text: "선택", value: ""},
        {text: "1시", value: "1"}, {text: "2시", value: "2"}, {text: "3시", value: "3"}, {text: "4시", value: "4"}, {text: "5시", value: "5"}, {text: "6시", value: "6"},
        {text: "7시", value: "7"}, {text: "8시", value: "8"}, {text: "9시", value: "9"}, {text: "10시", value: "10"}, {text: "11시", value: "11"}, {text: "12시", value: "12"},
      ...
      //상담채널 class 목록
      MSTATUS_CATE_CLASS_LIST: [
        { code: 'MOBILE', value: 'blue'},
        { code: 'PHONE', value: 'org'},
      ],
      //진행현황 class 목록 - 미완료 N, 완료 SST91, 제외 SST93, 종결(60일초과) SST92, 일정비협조 SST94
      SCH_STAT_TYPE_CLASS_LIST: [
        { code: 'N', value: 'blue'},
        { code: 'SST91', value: 'green'},
        { code: 'SST92', value: 'green'},
        { code: 'SST93', value: 'green'},
        { code: 'SST94', value: 'blueGray'},
      ],
  ...
  methods: {
    ...
    async setSchedulerDetail(item = null) {
      if(item != null) {
    ...
    initCntctInfo() {
      ...
      this.$store.commit("statusStore/MU_AS_SHDL_CALLER_TEL", this.AS_CNTCT_INFO.CALLER_TEL);
    ...
    async getCustCaution() {
      ...
      if(!response.HEADER.ERROR_FLAG) {
        ...
        console.log("this.CUST_CAUTION_INFO", this.CUST_CAUTION_INFO);
      }
    },
    ...
    async getRcvSchedulerStatus() {
      ...
      if(!response.HEADER.ERROR_FLAG) {
        if(response.DATA.length > 0) {
          ...
          this.FLW_ACP_INFO.MSTATUS = response.DATA[0].MSTATUS;
          this.FLW_ACP_INFO.MSTATUS_CATE = response.DATA[0].MSTATUS_CATE;
          this.FLW_ACP_INFO.MSTATUS_CATE_CD = response.DATA[0].MSTATUS_CATE_CD;
          this.FLW_ACP_INFO.WORK_TYPE_NM = response.DATA[0].WORK_TYPE_NM;
          this.FLW_ACP_INFO.SCH_STAT_TYPE = response.DATA[0].SCH_STAT_TYPE;
          this.FLW_ACP_INFO.SCH_STAT_TYPE_NM = response.DATA[0].SCH_STAT_TYPE_NM;
          this.FLW_ACP_INFO.VST_FIX_DT = this.convertDate(response.DATA[0].VST_FIX_DT);
    ...
    setRcvSchedulerStatus() {
      ...
      this.RCV_SCHEDULER_STATUS.H_SCH_STAT_CD = this.RCV_SCHEDULER_STATUS.SCH_STAT_TYPE;
    },
    ...
    async getNewFlwAcpDetail() {
      ...
      console.log("CompoAsSchedulerMobile_DETAIL selectCotisFlwAcpDetail", postParam)
      ...
      if(!response.HEADER.ERROR_FLAG) {
        ...
        console.log("this.FLW_ACP_INFO", this.FLW_ACP_INFO);
      }
    },
    ...
    setCuttType(data, selectedData) {
      console.log("setCuttType this.PREV_CNSLT_DIV_CD_1", this.PREV_CNSLT_DIV_CD_1)
      console.log("setCuttType data[0]", data[0])
    ...
    async asCntctSave() {
      ...
      console.log("asCntctSave", postParam)
    ...
    setIcpr(item) {
      ...
      if(item.FRM_NM) {
        ...
        this.AS_CNTCT_INFO.CALLER_NM = item.FRM_NM + "/" + item.MNTN_USR_DS_NM;
      } else {
        this.AS_CNTCT_INFO.ICPR_INFO = item.DEP_NM + "/" + item.MNTN_USR_DS_NM;
        this.AS_CNTCT_INFO.CALLER_NM = item.DEP_NM + "/" + item.MNTN_USR_DS_NM;
      }
      if(item.SEL_CALLER_TEL) {
        this.AS_CNTCT_INFO.CALLER_TEL = item.SEL_CALLER_TEL;
        this.$store.commit("statusStore/MU_AS_SHDL_CALLER_TEL", this.AS_CNTCT_INFO.CALLER_TEL);
      }
    ...
    //다건 저장 다이얼로그 - 적용 이벤트
    setMultiSave(items) {
      console.log("setMultiSave", items)
    ...
    //인바운드 이관 체크박스 변경 이벤트.
    changeInboundTranYn() {
      console.log("changeInboundTranYn", this.AS_CNTCT_INFO.INBOUND_TRAN_YN)
    ...
    //방문확정일 변경 이벤트
    changeVisitYmd() {
      console.log("this.RCV_SCHEDULER_STATUS.VISIT_YMD", this.RCV_SCHEDULER_STATUS.VISIT_YMD)
    ...
    async rcvSchedulerStatusSave() {
      ...
      console.log("rcvSchedulerStatusSave", postParam)
      this.$store.dispatch("commonStore/AC_COMMON_PROGRESS_BAR", true);
    ...
    closeDialogHappycall(surveyDstnNo) {
      console.log("closeDialogHappycall surveyDstnNo", surveyDstnNo)
    ...
    showSidePanel(name){
      ...
      if(this.FLW_ACP_INFO && this.FLW_ACP_INFO.V_FLW_ACP_SN) {
        ...
        console.log("mgofTpCd", mgofTpCd, this.FLW_ACP_INFO)
        const smsFlwInfo = {
    ...
    //유선배분 모바일전환  (접수일 모바일전송 실패하였으나 추후 모바일로 진행된 항목을 제외하는데사용)
    btnPhoneToMobile() {
      /* AS접수 항목 선택 체크 */
      const flwDtlFullSn = this.FLW_ACP_INFO.FLW_DTL_FULL_SN ? this.FLW_ACP_INFO.FLW_DTL_FULL_SN : ""; // AS접수풀번호
    ...
    async phoneToMobile() {
      ...
      let headParam = {head: {}}
      const response = await this.common_postCall('/phone-api/as/scheduler/updatePhoneToMobile', postParam, headParam);

      if (!response.HEADER.ERROR_FLAG) {
        this.showToastInfo({msg: "전환하였습니다."})
        this.closeAlert();
        //상세 새로고침
        this.setSchedulerDetail();
        //스케줄러 목록 초기화(재로딩).
        this.$eventBus.$emit('searchSchedulerListPaging');
        this.mixin_reloadCuttStat('CUTT_MONITOR_STAT'); //상담 모니터링 카운트 리로드
      }
    ...
    btnMobileToPhone() {
      ...
      if (this.FLW_ACP_INFO.VISITABLE_DT == "") {
        this.showAlertInfo({msg: "방문예정일이 없습니다."})
        return ;
      }
      this.showConfirmInfo({
        msg: '유선전환 하시겠습니까?'
    ...
    async mobileToPhone() {
      ...
      let headParam = {head: {}}
      const response = await this.common_postCall('/phone-api/as/scheduler/updateMobileToPhone', postParam, headParam);

      if (!response.HEADER.ERROR_FLAG) {
        this.showToastInfo({msg: "배분하였습니다."})
        this.closeAlert();
        //상세 새로고침
        this.setSchedulerDetail();
        //스케줄러 목록 초기화(재로딩).
    ...
    convertDate(date) {
      ...
      try {
        ...
        if(date.indexOf('A')>0) ampm='오전';
        if(date.indexOf('P')>0) ampm='오후';
  ...
  created() {
    console.log("this.$store.getters['userStore/GE_USER_ROLE']", this.$store.getters['userStore/GE_USER_ROLE'].groupCd)
    //
    this.$eventBus.$on('setSchedulerDetail',(item)=> {
      this.setSchedulerDetail(item);
      console.log("eventBus 수신 setSchedulerDetail ", item)
    });
    ...
    this.$eventBus.$on('chatMessagePaste' , (type, message) => {
      try {
        ...
        if (type === "NEW") {
          ...
          this.AS_CNTCT_INFO.CUTT_CN = orgString.substring(0, this.afterKeyDown ? start : start + nextLineCnt) + message + orgString.slice(this.afterKeyDown ? end : end + nextLineCnt);
  ...
  beforeDestroy() {
    ...
    this.$eventBus.$off("initAsSchedulerMobile"); //eventBus 중복방지를 위해 off
  ...
  watch: {
    CUTT_TIME() {
      console.log("CUTT_TIME", this.CUTT_TIME)
    },
    AS_CNTCT_INFO: {
      handler(newValue, oldValue) {
        console.log("watch AS_CNTCT_INFO", this.AS_CNTCT_INFO.CALLER_TEL,newValue, oldValue )
        if(newValue && newValue.CALLER_TEL) {
          this.$store.commit("statusStore/MU_AS_SHDL_CALLER_TEL", newValue.CALLER_TEL);
        } else {
          this.$store.commit("statusStore/MU_AS_SHDL_CALLER_TEL", '');
        }
        console.log("aaaaaaaaaaaaaaaaaaaaaaaa", this.computedAsShdlCallerTel)
        
      },
      deep: true,
      immediate: true,
    }
    // 'AS_CNTCT_INFO.CALLER_TEL': function (newVal, oldVal) {
    //   console.log("전화번호 변경:", oldVal, "->", newVal);
    //   if(newValue) {
    //     this.asShdlCallerTel = newValue;
    //   } else {
    //     this.asShdlCallerTel = '';
    //   }
    // }
  },
};
