...
import RightRentCalc from '@/views/page/RightRentCalc.vue';
...
import CSL_M1500_POP from '@/views/page/CSL_M1500_POP.vue' // 모회사 VOC - 팝업
import CSM_M1600_POP from '@/views/page/CSM_M1600_POP.vue' // 민원이송현황 - 팝업
import CompoRealTalkLogSearch from '@/components/CompoRealTalkLogSearch.vue' // 청약플러스- 팝업
import CompoConPgrsSearch from '@/components/CompoConPgrsSearch.vue' // 청약플러스- 팝업
import CompoAsTransSchedulerManager from '@/components/CompoAsTransSchedulerManager.vue' // 바로처리 스케줄러 이관목록록- 팝업
...
export default {
  components: {
    ...
    CompoConPgrsSearch,  /*공사진행현황*/
    CompoAsTransSchedulerManager, //바로처리 스케줄러 이관 목록
  },
  data() {
    return {
