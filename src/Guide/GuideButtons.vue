  ...
  <div class="guide-content">
    ...
    <div class="guide-card">
      <div class="guide-gap">
        ...
        <v-btn class="pl-btn is-trans">닫기</v-btn>
        <v-btn class="pl-btn is-esp">보조</v-btn>
        <v-btn class="pl-btn is-esp2">단지정보</v-btn>
        <v-btn class="pl-btn is-esp3">긴급 버튼</v-btn>
    ...
    <div class="guide-card">
      <div class="guide-gap">
        ...
        <v-btn class="pl-btn is-icon is-trans" disabled>
