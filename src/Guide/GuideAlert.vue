  ...
  <div class="guide-content">
    ...
    <div class="guide-card">
      <div class="guide-gap">
        ...
        <v-btn class="pl-btn" @click="showToast(TOAST_LEFT)" >왼쪽 메뉴용</v-btn>
        <v-btn class="pl-btn" @click="showMainToast(MAINTOAST_RESERVE)" >스택용</v-btn>
        <v-btn class="pl-btn" @click="showMainToast(MAINTOAST_RESERVE2)" >스택용2</v-btn>
        <v-btn class="pl-btn" @click="showMainToast(MAINTOAST_RESERVE3)" >스택용3</v-btn>
  ...
  data() {
    return {
      ...
      propsTableToast: [
        ...
        { name: 'minWidth', type: 'String', default: 'false', description: '최소 넓이'},
      ],
      ...
      TOAST_LEFT: {  msg: '왼쪽 메뉴용 입니다.', class: 'info type-mini', hasToastIcon: true, icon: 'mdi-information-outline', time: 3000, type: 'left', minWidth: '293px' },
      MAINTOAST_RESERVE: { icon: 'mdi-information-outline', msg: '스택 쌓는용입니다', },
      MAINTOAST_RESERVE2: { icon: 'mdi-information-outline', msg: '22스택 쌓는용입니다', class: 'success'},
      MAINTOAST_RESERVE3: { icon: 'mdi-information-outline', msg: '33스택 쌓는용입니다', class: 'warning'},
...
`data () {
  return {
    ...
    TOAST_LEFT: {  msg: '왼쪽 메뉴용 입니다.', class: 'info type-mini', hasToastIcon: true, icon: 'mdi-information-outline', time: 3000, type: 'left', minWidth: '293px' },
    MAINTOAST_RESERVE: { icon: 'mdi-information-outline', msg: '스택 쌓는용입니다', }
    MAINTOAST_RESERVE2: { icon: 'mdi-information-outline', msg: '22스택 쌓는용입니다', },
    MAINTOAST_RESERVE3: { icon: 'mdi-information-outline', msg: '33스택 쌓는용입니다', },,
  },
},` },
        ],
        srcInput_05: [
