  ...
  data() {
    return {
      ...
      propsTable: [
        ...
        { name: 'ParentStyleProp', type: 'String', default: 'undefined', description: 'DateRange 전용, 부모 스타일', },
        { name: 'IsViewDropPickerProp', type: 'Boolean', default: 'true', description: 'DateRange 전용, drop picker 설정', },
        { name: 'PickerRangeProp', type: 'Array', default: '[~~]', description: 'DateRange 전용, drop picker의 기간 설정', },
        { name: 'PickerType', type: 'String', default: 'date', description: '피커 타입, date, month', },
...
date3: (new Date(Date.now() - (new Date()).getTimezoneOffset() * 60000)).toISOString().substr(0, 10),
pickerRange: [
  { label: "1개월", day: 0, month: 1},
  { label: "3개월", day: 0, month: 3},
  { label: "6개월", day: 7, month: 6},
