<template>
  <div class="guide-content">
    ...
    <div class="guide-card">
      <div class="guide-gap">
        <input
          type="radio"
          name="CS_TYPE_SORT"
          class="pl-radio native-input type-check">
        <input
          type="radio"
          checked
          name="CS_TYPE_SORT"
    ...
    <div class="guide-card">
      <div class="guide-gap">
        <v-radio-group v-model="radioGroupSelected3" class="is-mt-m">
          <v-radio
    ...
    <div class="guide-card">
      <v-switch v-model="switch1">
        <template v-slot:label>
          <span class="pl-label">{{ switch1 ? 'ON' : 'OFF' }}</span>
        </template>
      </v-switch>
      <v-switch v-model="switch2">
        <template v-slot:label>
          <span class="pl-label">{{ switch2 ? 'ON' : 'OFF' }}</span>
        </template>
      </v-switch>
      <v-switch input-value="true" disabled>
        <template v-slot:label>
          <span class="pl-label">DISABLED ON</span>
        </template>
      </v-switch>
      <v-switch
        disabled>
        <template v-slot:label>
          <span class="pl-label">DISABLED OFF</span>
        </template>
      </v-switch>
      <v-switch class="pl-switch type-first-label" value="true">
        <template v-slot:label>
...
<v-switch class="ml-auto pl-switch type-first-label" value="true">
  <template v-slot:label>
    <span class="pl-label">스크롤</span>
  </template>
</v-switch>`
