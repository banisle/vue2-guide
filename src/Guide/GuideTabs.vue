<template>
  <div class="guide-content">
    <div class="guide-content-header">
      Components<v-icon class="mdi mdi-chevron-right"></v-icon><span>{{ SelectedProp }}</span>
    ...
    <h2>{{ toplink[2] }}</h2>
    <div class="guide-card">
      <v-tabs class="pl-tabs type-subtab" v-model="tabs2">
        <v-tab>
          <v-badge
            value="true"
            color="#0073ce"
    ...
    <guide-srcview :ModelProp.sync="source021" :SrcProp="srcAll.srcInput_021" />
    ...
    <div class="guide-card">
      <v-tabs class="pl-tabs type-main" >
        <v-tab>상담이력
          <span class="pl-tab-badge">{{ main_tab_badge[0] }}</span>
        </v-tab>
        <v-tab>VOC
          <span class="pl-tab-badge">{{ main_tab_badge[1] }}</span>
        </v-tab>
        <v-tab>예약콜
          <span class="pl-tab-badge">{{ main_tab_badge[2] }}</span>
        </v-tab>
        <v-tab-item>
          <div>Tab1 content</div>
        </v-tab-item>
    ...
    <div class="guide-card">
      <ul class="pl-sort-tabs">
        <li
          ...
          @click="mixin_selected_sort('SORT_ITEMS', index)"
          >
          {{ item.title }}
        </li>
      </ul>
    ...
    <!-- //mark: Tab Fill grow -->
    <h2>{{ toplink[6] }}</h2>
    <div class="guide-card" style="width: 600px;">
      <v-tabs
...
export default {
  ...
  data() {
    return {
      ...
      // MAIN TAB
      main_tab_badge: [22,33,5,11],

      // sort
      SORT_ITEMS: [
        { title: '전체', selected: false },
        { title: '일반', selected: false },
        { title: '공지', selected: false },
        { title: '긴급', selected: false },
      ],
